...
#define HOST_FIND_BY_SRV       0x001
#define HOST_FIND_BY_MX        0x002
#define HOST_FIND_BY_A         0x004
...
/* Codes for the places from which ACLs can be called. Keep in step with the
tables of names and response codes in globals.c. */
